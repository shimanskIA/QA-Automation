...
namespace Task5
{
    class Program
    {
        ...
        {
            Bird raven = new Bird(new Coordinate(0, 1, 0), BirdSpecies.Raven, false);
            raven.GetFlyTime(new Coordinate(100, 150, 80));
            raven.FlyTo(new Coordinate(1, 1, 200));
            Plane plane = new Plane(new Coordinate(12, 25, 633), PlaneManufacturers.Boeing, 13000.5, 900.8, 4, 19.35);
            plane.GetFlyTime(new Coordinate(926, 7123, 99));
            plane.FlyTo(new Coordinate(666, 666, 200));
            Drone drone = new Drone(new Coordinate(555, 7, 1), 1000, 8000, 1200);
